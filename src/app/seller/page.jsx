    ...
    <PageLoader>
      <Reveal>
        <div className="h-svh">
          ...
          {step != 1 && step != 4 && (
            <Reveal>
              <div className="lg:max-h-screen flex overflow-hidden flex-col lg:flex-row bg-white">
                <div className="w-full h-svh bg-blue-50/20 lg:w-1/2 form-scroll lg:overflow-y-auto flex justify-center px-6 py-30 lg:py-25">
                  {step === 2 && (
          ...
          {step === 4 && (
            <div className="flex h-svh flex-col items-center justify-center text-center py-10 gap-4">
              <Reveal>
